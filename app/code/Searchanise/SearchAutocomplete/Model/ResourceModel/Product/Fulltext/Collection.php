...
/**
 * Uncomment class definition bellow and comment the upper one for Amasty ShopBy compatibility
 */
// class Collection extends \Amasty\Shopby\Model\ResourceModel\Fulltext\Collection
{
    ...
    /**
     * Uncomment method definition bellow and comment the upper one for Amasty ShopBy compatibility
     */
    //public function getFacetedData($field, \Magento\Framework\Search\Response\QueryResponse $outerResponse = null)
    {
        $this->_renderFilters();
        ...
        if (!$this->searchRequest) {
            ...
            /**
             * Uncomment line bellow and comment the upper one for Amasty ShopBy compatibility
             */
            //return parent::getFacetedData($field, $outerResponse);
        }
