    ...
    public function execute()
    {
        ...
        if (!$this->dataHelper->checkPrivateKey()) {
            ...
            if ($profiler) {
                ...
                $options['seo'] = [
                    'catalog_seo_category_url_suffix' => $this->configuration->getValue('catalog/seo/category_url_suffix'),
                    'catalog_seo_product_url_suffix'  => $this->configuration->getValue('catalog/seo/product_url_suffix'),
                ];
