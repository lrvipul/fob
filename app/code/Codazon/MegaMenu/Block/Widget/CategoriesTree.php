...
class CategoriesTree extends Template implements IdentityInterface
{
    ...
    protected function _addSubMenu($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $custom_class = '';
        if($childLevel == 1 && $child->getName() == 'Amino Acids')
        {
            $custom_class = ' child-double';
        }
        $html .= '<ul class="level' . $childLevel . $custom_class. ' groupmenu-drop">';
    ...
    protected function _getMenuItemClasses(\Magento\Framework\Data\Tree\Node $item)
    {
        ...
        if($item->getLevel() == 1 && $item->getName() == 'Amino Acids')
        {
            $classes[] = 'parent-double';
        }
        return $classes;
    }
