...
class Timeline extends \Magento\Backend\Block\Template
{
    ...
    public function __construct(\Wyomind\CronScheduler\Helper\Delegate $wyomind, \Magento\Backend\Block\Template\Context $context, \Wyomind\CronScheduler\Model\ResourceModel\Task\CollectionFactory $collectionFactory, array $data = [])
    {
    ...
    public function getTimelineData()
    {
        ...
        foreach ($tasks as $task) {
            ...
            $tooltip = "<table class='task " . $type . "'>" . "<tr><td colspan='2'>" . $task->getJobCode() . "</td></tr>" . "<tr><td>" . __('Id') . "</td><td>" . $task->getId() . "</td></tr>" . "<tr><td>" . __('Status') . "</td><td>" . "<span class='grid-severity-" . $type . "'>" . $inner . "</span>" . "</td></tr>" . "<tr><td>" . __('Created at') . "</td><td>" . $this->addOffset($task->getCreatedAt()) . "</td></tr>" . "<tr><td>" . __('Scheduled at') . "</td><td>" . $this->addOffset($task->getScheduledAt()) . "</td></tr>" . "<tr><td>" . __('Executed at') . "</td><td>" . ($start != null ? $start : "") . "</td></tr>" . "<tr><td>" . __('Finished at') . "</td><td>" . ($end != null ? $end : "") . "</td></tr>";
            if ($messages != "") {
