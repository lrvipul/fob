...
class Options implements \Magento\Framework\Data\OptionSourceInterface
{
    ...
    public function __construct(\Wyomind\CronScheduler\Helper\Delegate $wyomind, \Wyomind\CronScheduler\Model\ResourceModel\Task\CollectionFactory $taskCollectionFactory)
    {
    ...
    public function toOptionArray()
    {
        if ($this->options === null) {
            ...
            foreach ($taskStatuses as $taskStatus) {
                $this->options[] = ["label" => $taskStatus->getStatus(), "value" => $taskStatus->getStatus()];
            }
        }
        return $this->options;
    }
