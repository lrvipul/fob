...
class TaskProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
     ...
     * @param array $data
     */
    public function __construct($name, $primaryFieldName, $requestFieldName, \Wyomind\CronScheduler\Model\ResourceModel\Task\CollectionFactory $collectionFactory, array $meta = [], array $data = [])
    {
