...
class JobProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct(\Wyomind\CronScheduler\Helper\Delegate $wyomind, $name, $primaryFieldName, $requestFieldName, \Magento\Framework\Filesystem\Directory\ReadFactory $directoryRead, array $meta = [], array $data = [])
    {
