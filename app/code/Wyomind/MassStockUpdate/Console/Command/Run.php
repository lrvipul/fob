...
class Run extends Command
{
     ...
     */
    public $_profilesCollectionFactory = null;
    ...
    )
    {
        ...
        try {
            ...
            foreach (explode(",", $profilesIds[0]) as $profilesId) {
                $profile = $this->_profilesCollectionFactory->create()->getList($profilesId)->getFirstItem();
