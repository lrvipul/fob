...
// attribute is mapped with a custom value
                    ...
                    break;
                case self::XML:
                    $search = array("g:", "ss:", "x:", "xs:", "xmlns:","i:", "xmlns:msdata", "msdata:", "xmlns");
                    $replace = array("g_", "ss_", "x_", "xs_", "xmlns_","i_", "xmlns_msdata", "msdata_", "xmlnamespace");
...
// attribute is mapped with a custom value
    ...
    function getLineRangeCondition(
        $parameters, $lineNumber, $identifier, $cell = [], $hasHeader = true
    )
    {
        $upTo = false;
        $range = false;
...
// One line
     ...
     */
    public
    function execPhp($script, &$cell = null, $self = null, $additionalData = [])
    {
     ...
     * @return array
     */
    public function prepareStorewiewsParameters($attributes)
    {
        $list = array();
        foreach ($this->getStoreviews($attributes) as $storeview) {
            $list[$storeview["code"]] = null;
        }
        return $list;
    }
