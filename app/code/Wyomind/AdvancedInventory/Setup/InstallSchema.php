...
class InstallSchema implements InstallSchemaInterface
{
    ...
    )
    {
        ...
        $this->_framework->setDefaultConfig("advancedinventory/settings/order_notification_from_date", $this->_coreDate->gmtDate('Y-m-d'));

        $this->_framework->setDefaultConfig("cataloginventory/options/can_subtract", 0);
