...
class CustomerRegisterSuccess implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function __construct(\Wyomind\PickupAtStore\Helper\Delegate $wyomind, PointOfSaleFactory $posModelFactory, CustomerFactory $customerFactory)
    {
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($preferredStore) {
            $preferredStore = json_decode($preferredStore, true);
